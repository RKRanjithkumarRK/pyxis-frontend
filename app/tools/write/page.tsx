  ...
  return (
    <div className="h-full flex flex-col bg-bg text-text-primary overflow-hidden select-none">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* ══ LEFT SIDEBAR (240px) ══════════════════════════════════════ */}
        <div className="w-60 flex-shrink-0 border-r border-border flex flex-col min-h-0 overflow-y-scroll overflow-x-hidden custom-scrollbar scrollable bg-sidebar">
